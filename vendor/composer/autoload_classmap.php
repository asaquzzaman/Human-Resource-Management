...
return array(
    'CPM_Proect' => $baseDir . '/class/test.php',
    ...
    'HRM\\Core\\Leave\\Leave_Transformer' => $baseDir . '/core/Leave/Leave_Transform.php',
    ...
    'HRM_Client' => $baseDir . '/class/client.php',
    'HRM_File' => $baseDir . '/class/file.php',
    'HRM_Upgrade' => $baseDir . '/class/upgrade.php',
    'Hrm_Admin' => $baseDir . '/class/admin.php',
    'Hrm_Ajax' => $baseDir . '/class/ajax.php',
    'Hrm_Attendance' => $baseDir . '/class/attendance.php',
    'Hrm_Db' => $baseDir . '/class/db.php',
    'Hrm_Employee' => $baseDir . '/class/employee.php',
    'Hrm_Employeelist' => $baseDir . '/class/employeelist.php',
    'Hrm_Evaluation' => $baseDir . '/class/evaluation.php',
    'Hrm_Init' => $baseDir . '/class/init.php',
    'Hrm_JsTemplate' => $baseDir . '/class/jstemplate.php',
    'Hrm_Leave' => $baseDir . '/class/leave.php',
    'Hrm_Pim' => $baseDir . '/class/pim.php',
    'Hrm_Scripts' => $baseDir . '/class/scripts.php',
    'Hrm_Settings' => $baseDir . '/class/settings.php',
    'Hrm_Time' => $baseDir . '/class/time.php',
    'Hrm_Update' => $baseDir . '/class/update.php',
