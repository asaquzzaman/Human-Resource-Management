                	...
                	<td :colspan="fields.length + 1" class="colspanchange">
                		<form :id="'hrm-edit-form-'+record.id" class="hrm-edit-form" action="" @submit.prevent="selfUpdate(record)">
							...
							<div class="submit inline-edit-save">
								<button @click.prevent="recordEditForm(record, false)" type="button" class="button cancel hrm-button-secondary alignleft">Cancel</button>
								<input :disabled="!canSubmit" type="submit" class="button button-primary hrm-button-primary save alignright" value="Update">
