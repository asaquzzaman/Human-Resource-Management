...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('span', {
    ...
    staticClass: "hrm-start-date"
  }, [_vm._v(_vm._s(_vm.dateFormat(_vm.financialStart)))]), _vm._v("\n\t\tto \n\t\t"), _c('span', {
    staticClass: "hrm-end-date"
  }, [_vm._v(_vm._s(_vm.dateFormat(_vm.financialEnd)))])]), _vm._v(" "), _c('div', {
    ...
    return _c('tr', [_c('td', [_vm._v(_vm._s(type.leave_type_name))]), _vm._v(" "), (type.id === 1) ? _c('td', [_vm._v("–")]) : _c('td', [_vm._v(_vm._s(_vm.pad(type.entitlement)))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm.pad(type.count)))]), _vm._v(" "), (type.id === 0) ? _c('td', [_vm._v("–")]) : _c('td', [_vm._v(_vm._s(_vm.pad(type.entitlement - type.count)))])])
  }), _vm._v(" "), _c('tr', [_vm._m(2), _vm._v(" "), _c('td', [_c('strong', [_vm._v(_vm._s(_vm.pad(_vm.total.entitlement)))])]), _vm._v(" "), _c('td', [_c('strong', [_vm._v(_vm._s(_vm.pad(_vm.total.taken_leave)))])]), _vm._v(" "), _c('td', [_c('strong', [_vm._v(_vm._s(_vm.pad(_vm.total.remain_leave)))])])])], 2)])])]), _vm._v(" "), _vm._l((_vm.records), function(record) {
    return _c('div', {
      staticClass: "postbox"
    }, [_c('h2', {
      staticClass: "hndle ui-sortable-handle"
