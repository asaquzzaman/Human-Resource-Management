...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('span', {
    ...
    return _c('tr', [_c('td', [_vm._v(_vm._s(type.leave_type_name))]), _vm._v(" "), (type.id === 1) ? _c('td', [_vm._v("–")]) : _c('td', [_vm._v(_vm._s(Math.round(type.entitlement).toFixed(2)))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(type.count))]), _vm._v(" "), (type.id === 0) ? _c('td', [_vm._v("–")]) : _c('td', [_vm._v(_vm._s(type.entitlement - type.count))])])
